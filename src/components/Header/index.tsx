...
const Header = () => {
  ...
  const options = [
    ...
    { label: "Charger", value: "1" },
    { label: "Data Cable", value: "2" },
    { label: "Mini Wifi UPS", value: "3" },
    { label: "Extension Board", value: "4" },
    { label: "Water Alarm", value: "5" },
              ...
              <div className="flex items-center gap-5">
                ...
                >
                  <span className="inline-block relative">
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5 bg-orangew-4.5 h-4.5 rounded-full text-white">
                      {product.length}
                    </span>
                  </span>
                ...
                <ul className="flex xl:items-center flex-col xl:flex-row gap-5 xl:gap-6">
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      <li
                        key={i}
                        className="group relative before:w-0 before:h-[3px] before:bg-orangebefore:absolute before:left-0 before:top-0 before:rounded-b-[3px] before:ease-out before:duration-200 hover:before:w-full "
                      >
                        <Link
                          href={menuItem.path}
