              ...
              <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-17.5">
                ...
                <div className="max-w-[539px] w-full">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="inline-flex font-medium text-custom-sm text-white bg-orangerounded py-0.5 px-2.5">
                      30% OFF
                    </div>
                  </div>
                  ...
                  <form onSubmit={(e) => e.preventDefault()}>
                    ...
                    <div className="flex flex-wrap items-center gap-4.5">
                      ...
                      <a
                        href="#"
                        className="inline-flex font-medium text-white bg-orangepy-3 px-7 rounded-md ease-out duration-200 hover:bg-red-dark"
                      >
                        Purchase Now
                      </a>
              ...
              <div className="flex flex-wrap items-center bg-white rounded-[10px] shadow-1 gap-5 xl:gap-12.5 py-4.5 px-4 sm:px-6">
                {tabs.map((item, key) => (
                  <button
                    ...
                    className={`font-medium lg:text-lg ease-out duration-200 hover:text-blue relative before:h-0.5 before:bg-orangebefore:absolute before:left-0 before:bottom-0 before:ease-out before:duration-200 hover:before:w-full ${
                      activeTab === item.id
